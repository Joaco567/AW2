                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        <div class="row g-2 align-items-center mb-3">
                            <div class="col-7">
                                <p class="price fw-bold m-0">$${producto.precio.toLocaleString()}</p>
                            </div>
                            <div class="col-5">
                                <!-- El input que faltaba en este archivo -->
                                <input type="number" id="${producto.id}" class="form-control form-control-sm text-center m-0" min="1" value="1">
                            </div>
                        </div>

                        <div class="text-center">
                            <button type="button" class="btn btn-outline-success w-100" 
                                    onclick="agregarAlCarrito('${producto.nombre.replace(/'/g, "\\'")}', '${producto.id}', ${producto.precio}, '${producto.imagen}')">
